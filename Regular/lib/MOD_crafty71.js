...
Crafty.c("Supportable", {
    ...
    _ground: null,
    _groundComp: null,
	_upsideDown: false, //MODIFIED CODE
	_upsideOffset: 0, //MODIFIED CODE
    ...
    _detectGroundTick: function() {
        ...
        /**MODIFIED CODE**/
        area._x = pos._x;
		if (this._upsideDown == true) {
			area._y = pos._y - 1; // SEARCHES ABOVE PLAYER FOR GROUND --Increase by 1 to make sure map.search() finds the floor
		} else { 
            ...
            for (; i < l; ++i) {
                ...
                if (obj !== this && obj.__c[groundComp] && overlap(oarea, area)) {
                    ...
                    if (this.canLand) {
						...
						/**MODIFIED CODE**/
						if (this._upsideDown == true) {
							//console.log('UPSIDE DOWN TRUE');
							this.y = obj._y + this._upsideOffset; // ALLOWS UNDERNEATH STICKING  snap entity to ground object
						} else {	
...
Crafty.c("Gravity", {
	...
	/**MODIFIED CODE**/
	upsideDown: function (up) {
        this._upsideDown = up;
        return this;
    },
	
	upsideOffset: function (num) {
        this._upsideOffset = num;
        return this;
    },
	/**END MODIFIED CODE**/
